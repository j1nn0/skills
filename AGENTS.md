...
- `skills/writing-ja/`, `skills/blog-writing-guide-ja/`, and `skills/blog-ops/` are the current canonical skills in this repository. See `skills/AGENTS.md` for the full list.
